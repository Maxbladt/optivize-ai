...
Vandaag is ${today()}. De agenda toont de komende 2 weken (10 werkdagen). Als de patiënt iets vraagt wat je niet weet, bied je aan om door te verbinden met een medewerker.

Beëindig het gesprek altijd netjes met de tool 'beeindig_gesprek' zodra de patiënt geholpen is en er niets meer te bespreken valt.`,
    tools: [
      {
        type: 'function',
      ...
      },
      {
        ...
        description: 'Beëindig het telefoongesprek netjes wanneer de patiënt klaar is. Eerst kort afsluiten ("Bedankt voor het bellen, een fijne dag!") en daarna deze functie aanroepen. Roep dit aan zodra de afspraak is geboekt en er niets meer te bespreken is.',
...
Beëindig het gesprek altijd netjes met de tool 'beeindig_gesprek' zodra de klant geholpen is.`,
    tools: [
      {
        type: 'function',
      ...
      },
      {
        type: 'function',
        name: 'beeindig_gesprek',
        description: 'Beëindig het gesprek netjes wanneer de klant geholpen is. Sluit eerst kort af ("Bedankt voor uw bestelling, een fijne dag!") en roep dan deze functie aan.',
        parameters: { type: 'object', properties: {} },
      },
    ],
  },
...
Beëindig het gesprek altijd netjes met de tool 'beeindig_gesprek' zodra de gast geholpen is.`,
    tools: [
      {
        type: 'function',
        name: 'vrije_tafels',
      ...
      },
      {
        type: 'function',
        name: 'beeindig_gesprek',
        description: 'Beëindig het gesprek netjes wanneer de gast geholpen is. Sluit eerst af ("Tot ziens, we kijken er naar uit!") en roep dan deze functie aan.',
        parameters: { type: 'object', properties: {} },
      },
    ],
  },
...
Beëindig het gesprek altijd netjes met de tool 'beeindig_gesprek' zodra de klant geholpen is.`,
    tools: [
      ...
      },
      {
        type: 'function',
        name: 'beeindig_gesprek',
        description: 'Beëindig het gesprek netjes wanneer de klant geholpen is. Sluit eerst af ("Bedankt voor uw interesse, tot binnenkort!") en roep dan deze functie aan.',
        parameters: { type: 'object', properties: {} },
      },
    ],
  },
