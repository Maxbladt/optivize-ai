...
export default async function sitemap() {
  ...
  const staticRoutes = [
    ...
    { url: 'https://optivaize.nl/ai-assistent/tandarts', lastModified: now },
    { url: 'https://optivaize.nl/ai-assistent/webshop', lastModified: now },
    { url: 'https://optivaize.nl/ai-assistent/restaurant', lastModified: now },
    { url: 'https://optivaize.nl/ai-assistent/makelaar', lastModified: now },
